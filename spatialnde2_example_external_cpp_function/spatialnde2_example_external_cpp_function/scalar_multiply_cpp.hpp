...
namespace snde2_fn_ex {
  ...
  template <typename T>
  class scalar_multiply: public snde::recmath_cppfuncexec<std::shared_ptr<snde::ndtyped_recording<T>>,snde_float64>
  {
  public:
    scalar_multiply(std::shared_ptr<snde::recording_set_state> wss,std::shared_ptr<snde::instantiated_math_function> inst) :
      snde::recmath_cppfuncexec<std::shared_ptr<snde::ndtyped_recording<T>>,snde_float64>(wss,inst)
    {
    ...
    typedef typename snde::recmath_cppfuncexec<std::shared_ptr<snde::ndtyped_recording<T>>,snde_float64>::metadata_function_override_type metadata_function_override_type;
    typedef typename snde::recmath_cppfuncexec<std::shared_ptr<snde::ndtyped_recording<T>>,snde_float64>::lock_alloc_function_override_type lock_alloc_function_override_type;
    typedef typename snde::recmath_cppfuncexec<std::shared_ptr<snde::ndtyped_recording<T>>,snde_float64>::exec_function_override_type exec_function_override_type;
  
    // just using the default for decide_new_revision and compute_options
    
    std::shared_ptr<metadata_function_override_type> define_recs(std::shared_ptr<snde::ndtyped_recording<T>> recording, snde_float64 multiplier) 
    {
      // define_recs code

...
#include "scalar_multiply_cpp.hpp"
...
namespace snde2_fn_ex {
  ...
  std::shared_ptr<snde::math_function> scalar_multiply_function=define_scalar_multiply();

  // Register the math function into the C++ database
  // This should use the same python-accessible name for
  // maximum interoperability

  int registered_scalar_multiply_function = register_math_function("spatialnde2_example_cpp_function.scalar_multiply_function",scalar_multiply_function);

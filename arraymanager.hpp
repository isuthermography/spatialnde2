...
namespace snde {
  ...
  public: 
    ...
    /* in this simple manager, allocators is presumed to be fixed
    ...
    simplearraymanager(const simplearraymanager &)=delete; /* copy constructor disabled */
    simplearraymanager& operator=(const simplearraymanager &)=delete; /* assignment disabled */
  ...
  class allocationinfo { /* currently only used by openclarraymanager */
  public:

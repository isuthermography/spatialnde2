...
namespace snde {
  ...
  template <typename T>
  class nd_accumulate_once : public recmath_cppfuncexec<std::shared_ptr<ndtyped_recording_ref<T>>, std::vector<snde_index>, std::vector<std::vector<snde_index>>, snde_index, snde_bool, snde_bool, snde_bool> {
  public:
    nd_accumulate_once(std::shared_ptr<recording_set_state> rss, std::shared_ptr<instantiated_math_function> inst) :
      recmath_cppfuncexec<std::shared_ptr<ndtyped_recording_ref<T>>, std::vector<snde_index>, std::vector<std::vector<snde_index>>, snde_index, snde_bool, snde_bool, snde_bool>(rss, inst)
    {
    ...
    typedef typename recmath_cppfuncexec<std::shared_ptr<ndtyped_recording_ref<T>>, std::vector<snde_index>, std::vector<std::vector<snde_index>>, snde_index, snde_bool, snde_bool, snde_bool>::compute_options_function_override_type compute_options_function_override_type;
    typedef typename recmath_cppfuncexec<std::shared_ptr<ndtyped_recording_ref<T>>, std::vector<snde_index>, std::vector<std::vector<snde_index>>, snde_index, snde_bool, snde_bool, snde_bool>::define_recs_function_override_type define_recs_function_override_type;
    typedef typename recmath_cppfuncexec<std::shared_ptr<ndtyped_recording_ref<T>>, std::vector<snde_index>, std::vector<std::vector<snde_index>>, snde_index, snde_bool, snde_bool, snde_bool>::metadata_function_override_type metadata_function_override_type;
    typedef typename recmath_cppfuncexec<std::shared_ptr<ndtyped_recording_ref<T>>, std::vector<snde_index>, std::vector<std::vector<snde_index>>, snde_index, snde_bool, snde_bool, snde_bool>::lock_alloc_function_override_type lock_alloc_function_override_type;
    typedef typename recmath_cppfuncexec<std::shared_ptr<ndtyped_recording_ref<T>>, std::vector<snde_index>, std::vector<std::vector<snde_index>>, snde_index, snde_bool, snde_bool, snde_bool>::exec_function_override_type exec_function_override_type;
    ...
    std::pair<bool, std::shared_ptr<compute_options_function_override_type>> decide_execution(std::shared_ptr<ndtyped_recording_ref<T>> to_accum, std::vector<snde_index> accum_dimlen, std::vector<std::vector<snde_index>> assignmap, snde_index numaccum, snde_bool fortran_mode, snde_bool emit_when_complete_only, snde_bool auto_reset) {
	...
	return std::make_pair(true, std::make_shared<compute_options_function_override_type>([this, just_starting, previous_recording, creator_data, to_accum, accum_dimlen, assignmap, fortran_mode, emit_when_complete_only, numaccum]() {
	  ...
	  return std::make_pair(option_list, std::make_shared<define_recs_function_override_type>([this, just_starting, previous_recording, creator_data, to_accum, accum_dimlen, assignmap, fortran_mode, emit_when_complete_only, numaccum]() {
	    // define_recs code
	    ...
	    return std::make_shared<metadata_function_override_type>([this, result, fortran_mode, accum_dimlen, just_starting, previous_recording, creator_data, to_accum, assignmap, emit_when_complete_only, numaccum]() {
	      // metadata code 
		...
		if (emit_when_complete_only) {
		  return std::make_shared<exec_function_override_type>([this, locktokens, result, fortran_mode, accum_dimlen, just_starting, previous_recording, previous_recording_ndarray, creator_data, assignmap, numaccum]() {
			...
			// Copy data
			memcpy(result->element_dataptr(0, assignmap.at(accumindex)), to_accum->void_shifted_arrayptr(), bytes_in_single_entry);
		  ...
		  return std::make_shared<exec_function_override_type>([this, locktokens, result, arraynum, fortran_mode, accum_dimlen, just_starting, previous_recording, previous_recording_ndarray, creator_data, to_accum, assignmap, numaccum]() {
		    ...
		    // Copy data
		    memcpy(result->element_dataptr(arraynum, assignmap.at(accumindex)), to_accum->void_shifted_arrayptr(), bytes_in_single_entry);

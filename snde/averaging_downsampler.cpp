...
*/
  ...
  {
    std::shared_ptr<math_function> newfunc = std::make_shared<cpp_math_function>("snde.averaging_downsampler",[] (std::shared_ptr<recording_set_state> rss,std::shared_ptr<instantiated_math_function> inst) {
